          ...
          <v-card-text>
            <v-container fluid>
              <v-row>
                ...
                <v-col cols="9">
                  <v-text-field
                      v-model="serverConfig.motd"
                      label="MOTD"
                      color="accent"
                      prepend-inner-icon="mdi-card-text-outline"
                      append-inner-icon="mdi-format-section"
                      @click:append-inner="serverConfig.motd += '§'"
                  />
                  <v-row class="mt-n8">
                    <v-col cols="6">
                      <v-text-field
                          v-model="serverConfig.maxPlayers"
                          label="Max Players"
                          color="accent"
